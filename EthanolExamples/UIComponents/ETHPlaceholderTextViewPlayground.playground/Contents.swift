...
// Changing text view font also udpates placeholder font 
ethPlaceholderTextView.font = UIFont.systemFontOfSize(35.0)

/*:
## What if we type in some text?
*/
ethPlaceholderTextView.font = UIFont.systemFontOfSize(12.0)
